...
int main()
{
	...
	times_m = abreArquivo(times_m, "quick_sort_pm_c.txt");
    times_r = abreArquivo(times_r, "quick_sort_pr_c.txt");

	plt::named_plot("Pivô elemento central", times_m);
    plt::named_plot("Pivô aleatório", times_r);
   
    plt::title("Quick sort: Comparando elementos ordenados em ordem crescente");
    plt::legend();
